...
/*
 ...
 "dynamic" FSMs with varying levels of inheritance.
 */
function runDynamicFsmSpec( description, fsmFactory ) {
	describe( "DynamicFsm", function() {
...
_.each( global.specFactory.dynamic, function( val, key ) {
	runDynamicFsmSpec( key, val );
} );
